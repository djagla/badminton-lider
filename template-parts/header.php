...
<header id="navbar" class="<?php echo $templateHeader; ?> !flex justify-center fixed top-0 left-0 w-full z-50 transition-colors duration-300">
    <nav class="main-nav">
            ...
            <div id="navbar-cta" class="essential-info-container">
                <div id="essential-info-contact" class="essential-info-contact">
                    <span>
                        ...
                        <path d="M1.75 1.75C1.75 10.25 5.75 14.25 14.25 14.25V10.25L10.75 9.25L9.75 10.75C7.75 10.75 5.25 8.25 5.25 6.25L6.75 5.25L5.75 1.75H1.75Z" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>	
                        +48 600 470 053
                    </span>
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M2 3.5H14C14.1326 3.5 14.2598 3.55268 14.3536 3.64645C14.4473 3.74021 14.5 3.86739 14.5 4V4.572L8 8.286L1.5 4.572V4C1.5 3.86739 1.55268 3.74021 1.64645 3.64645C1.74021 3.55268 1.86739 3.5 2 3.5ZM1.5 6.3V12C1.5 12.1326 1.55268 12.2598 1.64645 12.3536C1.74021 12.4473 1.86739 12.5 2 12.5H14C14.1326 12.5 14.2598 12.4473 14.3536 12.3536C14.4473 12.2598 14.5 12.1326 14.5 12V6.3L8.372 9.8L8 10.014L7.628 9.8L1.5 6.3ZM0 4C0 3.46957 0.210714 2.96086 0.585786 2.58579C0.960859 2.21071 1.46957 2 2 2H14C14.5304 2 15.0391 2.21071 15.4142 2.58579C15.7893 2.96086 16 3.46957 16 4V12C16 12.5304 15.7893 13.0391 15.4142 13.4142C15.0391 13.7893 14.5304 14 14 14H2C1.46957 14 0.960859 13.7893 0.585786 13.4142C0.210714 13.0391 0 12.5304 0 12V4Z" fill="white"/>
                        </svg>
                        biuro@badmintonlider.pl
                    </span>
                </div>
        ...
        class="md:hidden flex flex-col items-center gap-4 justify-center w-10 h-10 text-white"
