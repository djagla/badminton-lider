	...
	<header>
		<nav class="main-nav">
			...
			<div class="main-nav-wrapper">
				...
				<a class="button-link white" href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/wc_logo.svg" alt="Badminton Lider" />Wielicki Cup</a>
			</div>

			<a class="button-link" href="">Treningi</a>
		</nav>
	</header>
